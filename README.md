...
В этой игре показывается случайное число. Вам нужно ответить: "yes" — если число чётное, "no" — если число нечётное. Запуск игры с помощью команды brain-even.
...
В этой игре пользователю показывается случайное математическое выражение, которое необходимо решить. Ваша задача — ввести правильный ответ на выражение. Запуск игры с помощью команды brain-calc.
